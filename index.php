...
<head>
    ...
    ================================================== -->
    <meta charset="utf-8">
    <title>New Generation Foundation</title>
...
<body id="top">
    ...
    <header class="s-header">
        ...
        <div class="header-logo">
            <a class="site-logo" href="index.html">
               ...
               <img src="images/ngf.jpg" alt="Homepage">
            </a>
        </div> <!-- end header-logo -->
    ...
    <!-- home
    ================================================== -->
    <section id="home" class="s-home page-hero target-section" data-parallax="scroll" data-image-src="images/children.jpg" data-natural-width=3000 data-natural-height=2000 data-position-y=center>
        ...
        <div class="home-content">
            ...
            <div class="row home-content__main">
                ...
                <h3>
                We want to instill value in north eastern Nigerian children
                </h3>
    ...
    <!-- services
    ================================================== -->
    <section id='mission' class="s-services target-section darker">
    ...
    <section id="contact" class="s-contact target-section">
        ...
        <div class="row section-header narrow" data-aos="fade-up">
            <div class="col-full">
                ...
                <h1 class="display-1">Feel free to contact us for any <br> inquiries or collaboration</h1>
            </div>
        </div> <!-- end section-header -->
        ...
        <div class="row contact-main" data-aos="fade-up">
            <div class="col-full">
                <p class="contact-email" >
                    <a href="mailto:#0" style="font-size:32px;">hello@newgenfoundation.com</a>
                </p>
                
                <p class="contact-numbers">
                +2348060089165 &nbsp; +2348137933843
                </p>
    ...
    <footer>
        <div class="row">
            <div class="col-full ss-copyright">
                <span>© Copyright New Generation Foundation 2018</span> 
